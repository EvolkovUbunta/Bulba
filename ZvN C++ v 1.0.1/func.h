...
class pla
{
  ...
  public:
    pla *next;
    string giv_name() {	return name; }
    float giv_roz() { return roz; }
    float giv_pvvo() { return pvvo; }
    float giv_rad() { return rad; }
    float giv_srpl() { return srpl; }
    string giv_nstr() { return nstr; }
    string giv_nsoz() { return nsoz; }
    string giv_ngal() { return ngal; }
    void show_info();
...
class sta
{
  ...
  public:
    sta *next;
    string giv_name() { return name; }
    string giv_spkl() { return spkl; }
    string giv_cvet() { return cvet; }
    float giv_temp() { return temp; } 
    float giv_mass() { return mass; }
    float giv_zvvl() { return zvvl; }
    float giv_razm() { return razm; }
    string giv_nsoz() { return nsoz; }
    string giv_ngal() { return ngal; }
    void show_info();
    int get_info(control &ctrl);
...
class soz
{
  ...
  public:
    soz *next;
    string giv_name() { return name; }
    string giv_lnaz() { return lnaz; }
    float giv_plos() { return plos; }
    int giv_chzv() { return chzv; }
    string giv_sokr() { return sokr; }
    string giv_ngal() { return ngal; }
    void show_info();
    int get_info(control &ctrl);
...
class gal
{
  ...
  public:
    gal *next;
    string giv_name() { return name; }
    string giv_vgal() { return vgal; }
    float giv_diam() { return diam; }
    float giv_mass() { return mass; }
    float giv_ktm() { return ktm; }
    void show_info();
    int get_info();
    void get_file(string ga_name,string ga_vgal,float ga_diam,float ga_mass,float ga_ktm);
}; 

class control //для хранения указателей на начало и конец списков
{
  public:
      gal *gal_beg;
      gal *gal_end;
...
void sort_gala(control *ctrl);
void sort_sozv(control *ctrl);
void sort_star(control *ctrl);
void sort_plan(control *ctrl);
