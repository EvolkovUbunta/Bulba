...
void inp_clear() //могут быть баги из-за использования ссылки
{
  cin.clear();
  cin.ignore();
  //cin.sync();
...
void del_cont(control *ctrl,gal *rex,soz *cur_soz,sta *cur_sta, pla *cur_pla)
{
  while (cur_pla!=NULL)
  {
